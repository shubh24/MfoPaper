...
function ALO_toolbox_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ALO_toolbox (see VARARGIN)
...
% UIWAIT makes ALO_toolbox wait for user response (see UIRESUME)
...
function varargout = ALO_toolbox_OutputFcn(hObject, eventdata, handles) 
...
cbStr = 'web(''http://dx.doi.org/10.1016/j.advengsoft.2015.01.010'');';
...
[Best_score,Best_pos,cg_curve]=ALO(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,handles,value);
