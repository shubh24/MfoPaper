...
% trans_func species which transfer we wish to use
%______________________________________________________________________________________________

function [Best_flame_score,Best_flame_pos,Convergence_curve]=MFO(N,Max_iteration, ess, dat, trans_func)

display('MFO is optimizing your problem using transfer function');
dim = ess(1)
